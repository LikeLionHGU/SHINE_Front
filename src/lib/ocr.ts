...
const SYSTEM_PROMPT =
  ...
  "## 이 표의 생김새\n" +
  "한국 검사 결과지는 보통 [그룹검사 | 검사항목 | 1차결과 | 결과상태(정상/이상)] 같은 열로 되어 있어.\n" +
  "- rawValue에는 **숫자 결과가 있는 열**의 값을 넣어. \'정상\'·\'이상\' 같은 판정 열의 글자를 값으로 쓰지 마.\n" +
  "- 검사항목 이름이 \'일반혈액검사(CBC)-[혈구세포-장비측정]_백혈구수\'처럼 길면 **줄여 쓰지 말고 그대로** 옮겨.\n" +
  "- 한 행씩 왼쪽에서 오른쪽으로 읽어. 위아래 행의 값이 섞이지 않게 주의해.\n" +
  "- 결과상태 열에 \'△/이상·상한\', \'▽/이상·하한\' 같은 표시가 있으면 flag를 각각 \"H\", \"L\"로 넣어.\n\n" +
  "## 항목마다 뽑을 것\n" +
